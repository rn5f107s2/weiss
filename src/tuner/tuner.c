...
extern const int BlockingKnight;
...
static void InitBaseParams(TVector tparams) {
    ...
    InitBaseSingle(Shelter);
    InitBaseSingle(BlockingKnight);
...
static void InitCoefficients(TCoeffs coeffs) {
    ...
    InitCoeffSingle(Shelter);
    InitCoeffSingle(BlockingKnight);
